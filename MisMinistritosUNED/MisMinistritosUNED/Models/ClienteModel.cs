...
namespace MisMinistritosUNED.Models
{
    public class ClienteModel
    {
        ...
        [Required(ErrorMessage = "Campo Requerido")]
        [StringLength(60, MinimumLength = 10, ErrorMessage = "Se necesitan entre 10 y 60 caracteres")]
        [RegularExpression(@"^[a-zA-ZñÑáéíóúàèìòùÁÉÍÓÚÀÈÌÒÙüÜ0-9\s,]*$", ErrorMessage = "Digite un nombre completo válido")]
